...
public class MappingApple {
    ...
    // 사과의 특정 데이터를 추출
    public static <Y> List<Y> mappingApples(List<Apple> basket, AppleFunction<Apple, Y> func) {
    ...
    // 특정 객체의 특정 데이터를 추출
    public static <X, Y> List<Y> mapping(List<X> basket, GenericFunction<X, Y> func) {
        List<Y> mappedList = new ArrayList<>();
